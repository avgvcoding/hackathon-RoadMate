...
class _AmbulanceScreenState extends State<AmbulanceScreen> {
  ...
  Future<void> _fetchHospitals() async {
    try {
      ...
      // Prepare API request to fetch nearby hospitals.
      ...
      if (response.statusCode == 200) {
        ...
        _hospitals = results.map((json) => Place.fromJson(json)).toList();

        // Add markers for each hospital using a blue marker.
        for (var hospital in _hospitals) {
          _markers.add(
            Marker(
              markerId: MarkerId(hospital.displayName),
                  ...
                  return Padding(
                    ...
                    child: Card(
                      ...
                      child: InkWell(
                        borderRadius: BorderRadius.circular(16),
                        onTap: () {
                          _openInGoogleMaps(hospital.displayName);
                        },
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              // Header row with an icon and hospital title.
                              Row(
                                children: const [
                                  Icon(
                                    Icons.local_hospital,
                                    color: Color.fromARGB(255, 255, 27, 152),
                                    size: 28,
                                  ),
                                  SizedBox(width: 8),
                                  Text(
